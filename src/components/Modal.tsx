              ...
              >
                <DialogPanel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6">
                  ...
                  <div className="mt-5 flex justify-between gap-4">
                    <button
                      type="button"
                      className="w-full rounded bg-gray-600 font-bold p-3 uppercase text-white shadow hover:bg-gray-500"
                      onClick={closeModal}
                    >
                      Close
                    </button>
                    <button
                      type="button"
                      className="w-full rounded bg-orange-600 font-bold p-3 uppercase text-white shadow hover:bg-orange-500"
                      onClick={() => {
